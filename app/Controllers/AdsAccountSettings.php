    ...
    public function update($customerId)
    {
        ...
        try {
            ...
            $settings = [
                ...
                'budget_spending_threshold' => $this->request->getPost('budget_spending_threshold'),
                ...
                'pancake_show_other_orders' => $this->request->getPost('pancake_show_other_orders'),
                'account_id' => $account['id'],
            ];
